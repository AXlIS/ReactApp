...
class Constructor {
    ...
    protected protectedMethod() {
        return this.field + 100;
    }

    private privateMethod() { // Не доступен в наследниках
        return this.field + 500;
    }
}
...
class Child extends Constructor{
    ...
    public childMethod(){    // Понижать уровень доступа нельзя, но повышать можно
